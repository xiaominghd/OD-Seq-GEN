...
def prep_workspace(workspace, datasets, oridata):
    ...
    shutil.copy("/mnt/data/gonghaofeng/new1/MoveSim-master/data/%s/val.data" %
                oridata, "/mnt/data/gonghaofeng/new1/MoveSim-master/%s/%s/data/val.data" % (datasets,workspace))
    shutil.copy("/mnt/data/gonghaofeng/new1/MoveSim-master/data/%s/test.data" %
                oridata, "/mnt/data/gonghaofeng/new1/MoveSim-master/%s/%s/data/test.data" % (datasets,workspace))
