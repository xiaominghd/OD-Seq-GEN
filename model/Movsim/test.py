...
with open(r'data/geolife/gps', 'w', encoding='UTF8', newline='') as f:
    writer = csv.writer(f)
    # write the data
    writer.writerows(data)

with open (r'data/geolife/gps') as input_file:
    s = input_file.read().replace(',', ' ')
    with open (r'data/geolife/gps', 'w') as output_file:
        output_file.write(s)

# import pandas as pd
# from sklearn.model_selection import train_test_split

# data = pd.read_csv(r"data/geolife/real1.data")
...
# train.to_csv(r'data/geolife/train1.data', index=False)
# test.to_csv(r'data/geolife/test1.data', index=False)
# validation.to_csv(r'data/geolife/val1.data', index=False)